// components/OpeningHoursForm.tsx
import React, { useState } from 'react'
import Button from '@/components/ui/Button'
import Input from '@/components/ui/Input'
import Switcher from '@/components/ui/Switcher'
import { useFormValidation } from '../../../utils/hooks/useFormValidation'
import { openingHoursValidation } from '../../../utils/validationRules'
        ...
        if (isValid) {
            ...
            try {
                const openingHoursData: OpeningHours = {
                    ...
                    ...(scheduleMode === 'daily'
                        ? {
                              dailyOpenTime: formData.dailyOpenTime,
                              dailyCloseTime: formData.dailyCloseTime,
                          }
                        : {
                              daySchedules,
                          }),
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex-1 space-y-4">
                ...
                {scheduleMode === 'customize' && (
                    <div className="space-y-4">
                        <p className="text-sm text-gray-600">
                            Set hours for the current day. Customize each day's
                            schedule below.
                        </p>
