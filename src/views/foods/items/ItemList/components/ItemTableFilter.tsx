...
// import useProductList from '../hooks/useItemList'
...
// const itemTypeList = ['Bags', 'Cloths', 'Devices', 'Shoes', 'Watches']
...
//                                 render={({ field }) => (
//                                     <Select<Option>
//                                         options={itemStatusOption}
//                                         {...field}
//                                         value={itemStatusOption.filter(
//                                             (option) =>
