...
export const merchantData = {
    ...
    description:
        'A cozy neighborhood café serving freshly brewed coffee and artisan pastries.',
    email: 'contact@brewhaven.co.uk',
    dialCode: '+44',
    phoneNumber: '+44-7555-112233',
    country: 'UK',
    addressLine1: '85 Kingsway Road',
